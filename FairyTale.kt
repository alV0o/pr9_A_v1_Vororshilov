class FairyTale(var empName: String, var empAuthor: String, var empYear: Int, var empVolumePages: Int, var empPrice: Double):Book(empName, empAuthor, empYear, empVolumePages, empPrice) {
    ...
    override fun GetInfo(){
        ...
        println("Год выпуска: ${year}. Количество страниц: ${countPages}. Цена с учетом скидки: ${price - discount}p")
    }

    override fun TypeOfBook(){
        println("Сказка - это детский вид книги. Она подходит для чтения ребенку на ночь, либо в поучительных целях")
    }
}